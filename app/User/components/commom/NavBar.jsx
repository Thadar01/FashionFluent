  ...
  return (
    <div className="bg-white h-[70px] flex  items-center gap-10 sticky top-0 z-50">
      ...
      <div className="flex absolute right-3 gap-3 items-center sm:w-[30%] justify-end mr-2 ">
        ...
        <Link
          href="/User/SignIn"
          className="md:w-[40%] lg:w-[15%] relative after:block after:content-[''] after:absolute after:left-0 after:w-full after:h-[2px] after:bg-[#FFD2A2] after:bottom-[-4px] after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300"
        >
          Sign in
        </Link>
